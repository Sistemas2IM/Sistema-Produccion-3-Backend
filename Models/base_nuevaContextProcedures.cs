...
namespace Sistema_Produccion_3_Backend.Models
{
    ...
    public partial class base_nuevaContextProcedures : Ibase_nuevaContextProcedures
    {
        ...
        public virtual async Task<List<FFE_DetalleProcesosResult>> FFE_DetalleProcesosAsync(int? idOF, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var sqlParameters = new []
            {
                ...
                {
                    ParameterName = "idOF",
                    Value = idOF ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<FFE_DetalleProcesosResult>("EXEC @returnValue = [dbo].[FFE_DetalleProcesos] @idOF = @idOF", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<FFE_ResumenOFResult>> FFE_ResumenOFAsync(int? idOF, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<FFE_ResumenOFResult>("EXEC @returnValue = [dbo].[FFE_ResumenOF] @idOF = @idOF", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<infoConversionBobinaResult>> infoConversionBobinaAsync(string codBobina, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "codBobina",
                    Size = 100,
                    Value = codBobina ?? Convert.DBNull,
        ...
        public virtual async Task<List<ResumenOfResult>> ResumenOfAsync(int? numOf, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                {
                    ParameterName = "numOf",
                    Value = numOf ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<ResumenOfResult>("EXEC @returnValue = [dbo].[ResumenOf] @numOf = @numOf", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<TimeInListResult>> TimeInListAsync(int? idProceso, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var sqlParameters = new []
            {
                new SqlParameter
                {
                    ParameterName = "idProceso",
                    Value = idProceso ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<TimeInListResult>("EXEC @returnValue = [dbo].[TimeInList] @idProceso = @idProceso", sqlParameters, cancellationToken);
