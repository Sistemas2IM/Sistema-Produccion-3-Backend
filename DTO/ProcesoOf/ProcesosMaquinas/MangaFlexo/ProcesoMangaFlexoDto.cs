...
namespace Sistema_Produccion_3_Backend.DTO.ProcesoOf.ProcesosMaquinas.MangaFlexo
{
    public class ProcesoMangaFlexoDto
    {
        [JsonIgnore]
        public int idProcesoMangaFlexo { get; set; }
